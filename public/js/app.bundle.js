...
const AppContainer_1 = __importDefault(__webpack_require__(36));
const store_1 = __importDefault(__webpack_require__(67));
const router = __importStar(__webpack_require__(80));
const scroll = __importStar(__webpack_require__(81));
const api = __importStar(__webpack_require__(39));
const route_1 = __webpack_require__(60);
const spinner_1 = __webpack_require__(73);
...
/* harmony import */ var _components_connectAdvanced__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(12);
...
/* harmony import */ var _babel_runtime_helpers_esm_extends__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(14);
/* harmony import */ var _babel_runtime_helpers_esm_objectWithoutPropertiesLoose__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(15);
/* harmony import */ var hoist_non_react_statics__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(16);
...
/* harmony import */ var react_is__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(17);
...
/* harmony import */ var _babel_runtime_helpers_esm_objectWithoutPropertiesLoose__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(15);
/* harmony import */ var _components_connectAdvanced__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(12);
...
/* harmony import */ var _babel_runtime_helpers_esm_objectWithoutPropertiesLoose__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(15);
...
Object.defineProperty(exports, "__esModule", { value: true });
const react_redux_1 = __webpack_require__(3);
const route_1 = __webpack_require__(37);
const auth_1 = __webpack_require__(38);
const App_1 = __importDefault(__webpack_require__(40));
...
exports.login = () => {
    return async (dispatch, getState) => {
        ...
        if (result) {
            dispatch(exports.authSuccessful());
        }
    };
};
exports.logout = () => {
...
Object.defineProperty(exports, "__esModule", { value: true });
const react_1 = __importDefault(__webpack_require__(1));
const InvalidListContainer_1 = __importDefault(__webpack_require__(41));
const LoginContainer_1 = __importDefault(__webpack_require__(47));
const FeedListContainer_1 = __importDefault(__webpack_require__(50));
const ArticlesContainer_1 = __importDefault(__webpack_require__(54));
const SearchContainer_1 = __importDefault(__webpack_require__(58));
const UrlsContainer_1 = __importDefault(__webpack_require__(62));
const Spinner_1 = __importDefault(__webpack_require__(65));
const Menu_1 = __importDefault(__webpack_require__(66));
const content = (props) => {
...
Object.defineProperty(exports, "__esModule", { value: true });
const react_redux_1 = __webpack_require__(3);
const invalid_1 = __webpack_require__(42);
const InvalidList_1 = __importDefault(__webpack_require__(43));
const mapStateToProps = (state) => ({
    authenticated: state.auth.authenticated,
...
Object.defineProperty(exports, "__esModule", { value: true });
const react_1 = __importDefault(__webpack_require__(1));
const classlist_1 = __importDefault(__webpack_require__(46));
exports.default = (props) => {
...
Object.defineProperty(exports, "__esModule", { value: true });
const react_redux_1 = __webpack_require__(3);
const login_1 = __webpack_require__(48);
const Login_1 = __importDefault(__webpack_require__(49));
const mapStateToProps = (state) => ({
    user: state.login.user,
    pass: state.login.pass,
});
const mapDispatchToProps = (dispatch) => ({
    setUser: (e) => dispatch(login_1.setUser(e)),
    setPass: (e) => dispatch(login_1.setPass(e)),
    submit: (e) => dispatch(login_1.submit(e))
});
/**
 * Fetch - based container component for the list of invalid feeds.
 */
...
exports.submit = (e) => {
    e.preventDefault();
    return (dispatch) => {
        dispatch(auth_1.login());
    };
};
exports.setUser = (e) => ({ type: exports.LOGIN_SET_USERNAME, user: e.target.value });
exports.setPass = (e) => ({ type: exports.LOGIN_SET_PASSWORD, pass: e.target.value });
 ...
 */
exports.default = (props) => {
    return (react_1.default.createElement("form", { className: 'form-inline', onSubmit: props.submit },
        react_1.default.createElement("input", { type: 'text', name: 'user', placeholder: 'user', className: 'input-small', value: props.user, onChange: props.setUser }),
        react_1.default.createElement("input", { type: 'password', name: 'pass', placeholder: 'pass', className: 'input-small', value: props.pass, onChange: props.setPass }),
...
Object.defineProperty(exports, "__esModule", { value: true });
const react_redux_1 = __webpack_require__(3);
const feeds_1 = __webpack_require__(51);
const FeedList_1 = __importDefault(__webpack_require__(52));
const mapStateToProps = (state) => ({
    authenticated: state.auth.authenticated,
...
Object.defineProperty(exports, "__esModule", { value: true });
const react_1 = __importDefault(__webpack_require__(1));
const Feed_1 = __importDefault(__webpack_require__(53));
exports.default = (props) => {
...
Object.defineProperty(exports, "__esModule", { value: true });
const react_redux_1 = __webpack_require__(3);
const articles_1 = __webpack_require__(55);
const Articles_1 = __importDefault(__webpack_require__(56));
const mapStateToProps = (state) => ({
    authenticated: state.auth.authenticated,
...
exports.deleteFeed = (articleId) => {
    return async (dispatch, getState) => {
        ...
        if (article) {
            ...
            dispatch(exports.loadInitial(state.articles.source));
        }
    };
};
/**
...
exports.markRead = (articleId) => {
    return async (dispatch, getState) => {
        dispatch({ type: exports.ARTICLES_TOGGLE_READ, articleId });
...
exports.markImportant = (articleId) => {
    return async (dispatch, getState) => {
        dispatch({ type: exports.ARTICLES_TOGGLE_IMPORTANT, articleId });
        const article = getState().articles.items.find((article) => article.uuid === articleId);
        if (article) {
...
exports.markSeen = (articleId) => {
    return async (dispatch, getState) => {
        ...
        if (index >= 0) {
            ...
            dispatch({ type: exports.ARTICLES_MARK_SEEN, articleId });
...
exports.read = (articleId) => {
    return async (dispatch, getState) => {
        dispatch({ type: exports.ARTICLES_MARK_READ, articleId });
        const state = getState();
        const article = state.articles.items.find((article) => article.uuid === articleId);
        if (article) {
...
Object.defineProperty(exports, "__esModule", { value: true });
const react_1 = __importDefault(__webpack_require__(1));
const Article_1 = __importDefault(__webpack_require__(57));
/**
...
const react_1 = __importDefault(__webpack_require__(1));
const Button_1 = __importDefault(__webpack_require__(45));
const deleteFeed = (article, props) => {
...
exports.default = (props) => {
    ...
    return (react_1.default.createElement("div", { className: 'well well-small' },
        ...
        react_1.default.createElement("div", { className: 'buttons' },
            react_1.default.createElement(Button_1.default, { disabled: !authenticated, onClick: () => deleteFeed(item, props) }, "Delete feed"),
...
Object.defineProperty(exports, "__esModule", { value: true });
const react_redux_1 = __webpack_require__(3);
const search_1 = __webpack_require__(59);
const Search_1 = __importDefault(__webpack_require__(61));
const mapStateToProps = (state) => ({
    query: state.search.query
});
const mapDispatchToProps = (dispatch) => ({
    setQuery: (e) => dispatch(search_1.setQuery(e)),
    submit: (e) => dispatch(search_1.submit(e))
});
/**
...
exports.submit = (e) => {
    e.preventDefault();
    return (dispatch) => {
        dispatch(route_1.routeView('results'));
    };
};
exports.setQuery = (e) => ({ type: exports.SEARCH_SET_QUERY, query: e.target.value });
...
Object.defineProperty(exports, "__esModule", { value: true });
const invalid = __importStar(__webpack_require__(42));
const feeds = __importStar(__webpack_require__(51));
const articles = __importStar(__webpack_require__(55));
 ...
 */
exports.routeRefresh = () => {
    return (dispatch, getState) => {
        const state = getState();
        const view = state.route.view;
        const args = state.route.args;
        if (view !== null) {
            dispatch(exports.routeView(view, args));
        }
    };
};
/**
...
exports.default = (props) => {
    return (react_1.default.createElement("form", { className: 'form-inline', onSubmit: props.submit },
        react_1.default.createElement("input", { type: 'text', name: 'query', placeholder: 'search term', onChange: props.setQuery }),
...
Object.defineProperty(exports, "__esModule", { value: true });
const react_redux_1 = __webpack_require__(3);
const urls_1 = __webpack_require__(63);
const Urls_1 = __importDefault(__webpack_require__(64));
const mapStateToProps = (state) => ({
    text: state.urls.text
});
const mapDispatchToProps = (dispatch) => ({
    setText: (e) => dispatch(urls_1.setText(e)),
    submit: (e) => dispatch(urls_1.submit(e))
});
/**
...
exports.submit = (e) => {
    ...
    return async (dispatch, getState) => {
        ...
        dispatch({ type: exports.URLS_SET_TEXT, text: '' });
 ...
 */
exports.setText = (e) => ({ type: exports.URLS_SET_TEXT, text: e.target.value });
 ...
 */
exports.default = (props) => {
    return (react_1.default.createElement("form", { onSubmit: props.submit },
        react_1.default.createElement("label", { htmlFor: 'urls' }, "Add list of feed URLs (one per line)"),
        react_1.default.createElement("textarea", { id: 'urls', onChange: props.setText, rows: 3, value: props.text }),
        react_1.default.createElement("br", null),
...
Object.defineProperty(exports, "__esModule", { value: true });
const redux_1 = __webpack_require__(23);
const route_1 = __importDefault(__webpack_require__(70));
const invalid_1 = __importDefault(__webpack_require__(71));
const spinner_1 = __importDefault(__webpack_require__(72));
const auth_1 = __importDefault(__webpack_require__(74));
const login_1 = __importDefault(__webpack_require__(75));
const feeds_1 = __importDefault(__webpack_require__(76));
const articles_1 = __importDefault(__webpack_require__(77));
const search_1 = __importDefault(__webpack_require__(78));
const urls_1 = __importDefault(__webpack_require__(79));
