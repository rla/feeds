...
module.exports = function(app) {
    ...
    // Marks article gplussed, requires authentication.

    app.put('/article/:uuid/gplussed', authed, function(req, res) {
        var uuid = req.params.uuid;
        article.markGplussed(uuid, respond(res));
    });
    ...
    app.del('/feed/:uuid', authed, function(req, res) {
        var uuid = req.params.uuid;
        async.series([
